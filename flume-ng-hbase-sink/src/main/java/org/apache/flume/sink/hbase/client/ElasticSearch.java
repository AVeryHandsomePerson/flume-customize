...
public class ElasticSearch implements ElasticSearchClient {
    ...
    public Client addClient(String clusterName, String ip, String post) {
        ...
        client = TransportClient.builder().settings(settings).build()
                .addTransportAddress(new InetSocketTransportAddress(new InetSocketAddress(ip, Integer.parseInt("9300"))));//待定
        return client;
    }
    ...
    public static void main(String[] args) {
        ...
        Client client = elasticSearch.addClient("elasticsearch", "test001", "9300");
        System.out.println(client);
//        System.out.println(elasticSearch.judge(client,"abcde"));
    }
